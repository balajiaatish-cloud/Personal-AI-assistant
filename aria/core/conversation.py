...
from aria.llm.base import BaseLLMProvider, LLMMessage
...
class ConversationManager:
    ...
    def __init__(
        ...
        self.provider: BaseLLMProvider = provider or MockProvider()
        self.session_id: str = session_id or str(uuid.uuid4())
    ...
    def process_user_message(self, user_input: str) -> str:
        ...
        2. Generate response using the injected provider.
        ...
        response = self.provider.generate(llm_messages)
