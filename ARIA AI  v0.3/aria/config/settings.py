...
class AppConfig:
    def __init__(self, name: str = "ARIA", version: str = "0.3.0", environment: str = "development"):
        self.name = name
...
class LLMConfig:
    def __init__(self, raw_llm: Optional[Dict[str, Any]] = None):
        raw = raw_llm or {}
...
class Settings:
    """
    Centralized Settings holding application, logging, module, and LLM configurations.
    """
    def __init__(
        self,
    ...
    def from_yaml(cls, config_path: str) -> "Settings":
        ...
        app_cfg = AppConfig(
            ...
            version=app_data.get("version", "0.3.0"),
            environment=env
        )
        ...
        return cls(app=app_cfg, logging_cfg=logging_cfg, modules=modules_cfg, llm=llm_cfg)
